...
<head>
    ...
    <title>Login User | Poliklinik BK</title>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">Masukkan data yang sudah didaftarkan dengan benar !
                                        </p>
                                    </div>
                                    ...
                                    <form class="row g-3 needs-validation" novalidate>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <div class="invalid-feedback">Masukkan nama terdaftar.</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <div class="invalid-feedback">Masukkan alamat terdaftar.</div>
                                            </div>
                                        </div>

                                        <div class="col-12">
                                            <button class="btn btn-primary w-100 btnLogin" type="submit">Login</button>
                                        </div>
                                        <div class="col-12">
                                            <p class="small mb-0">Belum punya akun? <a
                                                    href="<?=base_url('auth/page_daftar')?>">Daftar Akun Pasien</a></p>
                                        </div>
                                    </form>
