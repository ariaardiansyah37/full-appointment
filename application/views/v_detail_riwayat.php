...
<head>
    ...
    <title>Detail Riwayat Periksa | Poliklinik BK</title>
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Detail Riwayat Periksa</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Detail Riwayat Periksa</h5>
